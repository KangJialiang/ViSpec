...
<a href="https://arxiv.org/"><img src="https://img.shields.io/static/v1?label=Paper&message=arXiv&color=red&logo=arxiv"></a>
<!-- <a href="https://huggingface.co/"><img src="https://img.shields.io/static/v1?label=HuggingFace&message=Demo&color=yellow"></a> -->
...
**Note:** We provide several pre-trained model checkpoints in the `checkpoints/` directory. If you wish to use these, you can skip the data generation and training sections and proceed directly to **Stage 3: Evaluation**.
...
python -m vispec.evaluation.gen_baseline_answer_xxx \
  ...
  --spec-model-path=checkpoints/your_model_directory \
  --temperature=<value>
```
...
**Parameters**:
  ...
  - `--spec-model-path`: Path to the directory containing the ViSpec model checkpoint. **Note**: The checkpoint file must be named `model.safetensors`. This can be a model you trained or a pre-trained one.
...
| **Pangu-VL 7B (T=0)**   | **ViSpec** |  **1.97**  |  **1.61x**  |  **1.91**  |  **1.67x**  |  **2.13**  |  **1.71x**  |  **2.06**  |  **1.67x**  |  **2.68**  |  **2.17x**  |  **2.21**  |  **1.81x**  |  **2.28**  |  **1.75x**  |  **2.37**  |  **1.83x**  |  **2.20**  |  **1.78x**  |
...
| **Pangu-VL 7B (T=1)**   | **ViSpec** |  **1.82**  |  **1.45x**  |  **1.65**  |  **1.42x**  |  **1.73**  |  **1.39x**  |  **1.81**  |  **1.51x**  |  **2.16**  |  **1.70x**  |  **1.68**  |  **1.37x**  |  **1.87**  |  **1.52x**  |  **1.94**  |  **1.52x**  |  **1.83**  |  **1.49x**  |
...
This work is supported by Huawei Noah's Ark Lab. We thank all anonymous reviewers for their insightful comments.